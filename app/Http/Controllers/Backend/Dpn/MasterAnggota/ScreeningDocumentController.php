...
class ScreeningDocumentController extends Controller
{
    public function showDocumentAnggotaBaru($id_detail_kta)
    {
        ...
        return view('backend/dpn/content-pages/master-anggota.screening', compact('dataAdministrasiBu', 'dataPjbu', 'dataLegalitasBu', 'dataDokumen', 'id_detail_kta'));
    }
    ...
    public function showDocumenPemberhentiantAnggota($id_detail_kta)
    {
        ...
        // dd($dataPemberhentian);
        return view('backend/dpn/content-pages/master-anggota.screening-pemberhentian', compact('dataAdministrasiBu', 'dataPjbu', 'dataLegalitasBu', 'dataDokumen', 'dataPemberhentian','id_detail_kta'));
    }
    ...
    public function showDocumentPindahAnggota($id_detail_kta)
    {
        ...
        return view('backend/dpn/content-pages/master-anggota.screening_pindah', compact('dataAdministrasiBu', 'dataPjbu', 'dataLegalitasBu', 'dataDokumen'));
    }
    ...
    public function showDocumentNaikKualifikasi($id_detail_kta)
    {
        ...
        return view('backend/dpn/content-pages/master-anggota.screening_naik_kualifikasi', compact('dataAdministrasiBu', 'dataPjbu', 'legalitasBu', 'dataLegalitasBu', 'dataDokumen', 'id_detail_kta'));
    }
    ...
    public function showDocumentTurunKualifikasi($id_detail_kta)
    {
        ...
        return view('backend/dpn/content-pages/master-anggota.screening_turun_kualifikasi', compact('dataAdministrasiBu', 'dataPjbu', 'legalitasBu', 'dataLegalitasBu', 'dataDokumen', 'id_detail_kta'));
    }
    ...
    public function showDocumentEditData($id_detail_kta)
    {
        ...
        return view('backend/dpn/content-pages/master-anggota.screening_edit_data', compact('dataAdministrasiBu', 'dataPjbu', 'legalitasBu', 'dataLegalitasBu', 'dataDokumen', 'id_detail_kta'));
    }
