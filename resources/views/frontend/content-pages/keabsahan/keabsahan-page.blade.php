...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/frontV2') }}//packages/fontawesome/css/fontawesome.css">
        ...
        <nav class="navbar navbar-expand-lg menu_one menu_four">
            <div class="container">
                <a class="navbar-brand sticky_logo" href="{{ url('/') }}">
                    <img src="{{ asset('frontend/frontV2') }}/assets/img/logo-white.png" srcset="assets/img/logo-white.png 2x" alt="logo">
                    <img src="{{ asset('frontend/frontV2') }}/assets/img/logo.png" srcset="assets/img/logo.png 2x" alt="">
                </a>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-6 align-self-center text-center">
                            <h1 class="title">
                                Cek Keabsahan Anggota
                            </h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-blog justify-content-center">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Cek Keabsahan Anggota</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            Nama Penanggungjawab Badan Usaha
                                        </td>
                                        <td>
												{{ $dataAnggota->nm_pjbu }}
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
												{{ $dataAnggota->kualifikasi }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Status Keanggotaan Badan Usaha
                                        </td>
                                        <td>
                                            @if ($dataAnggota->status_kta == 0)
												Aktif
											@elseif($dataAnggota->status_kta == 1)
												Pasif
												@elseif($dataAnggota->status_kta == 2)
												Expired / Berhenti
											@endif
                                        </td>
                                    </tr>
