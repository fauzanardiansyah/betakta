    ...
    <main>
                        ...
                        <div class="col-md-9 align-self-center text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-blog justify-content-center">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Daftar Pengurus Inkindo</li>
                                </ol>
                            </nav>
        ...
        <section class="information">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    @foreach ($pengurusInkindo as $pengurusInkindoRow)
                    <div class="col-12 col-md-6 col-lg-4">
                     <div class="card-branch">
                         <div class="content">
                             <h4 class="name">
                                 <a href="#">
                                     {{ $pengurusInkindoRow->nama_provinsi }}
                                 </a>
                             </h4>
                             <!-- <p class="position">
                                 Inkindo Branch
                             ...
                             <ul>
                                 <li>
                                     ...
                                     <span>
                                         {{ $pengurusInkindoRow->alamat }}
                                     </span>
                                 </li>
                                 <li>
                                     <i class="fas fa-phone mr-2"></i>
                                     <span>
                                         {{ $pengurusInkindoRow->no_telp_dewan_pengurus }}
                                     </span>
                                 </li>
                                 <li>
                                     <i class="fas fa-envelope mr-2"></i>
                                     <span>
                                         {{ $pengurusInkindoRow->email_dewan_pengurus }}
                                     </span>
                                 </li>
                             </ul>
                         </div>
