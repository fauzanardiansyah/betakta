        ...
        <div class="col-lg-12">
            <div class="main-card mb-3 card">
                <div class="card-body"><h5 class="card-title">Semua Dewan Pengurus Provinsi Inkindo</h5>
                    <a href="{{ route('administrator.dewan.form-add-akun-dpp') }}" class="mb-2 mr-2 btn btn-alternate">Tambah Akun Pengurus Provinsi</a>
...
<script>
    $(function() {
        $('#dewan-pengurus-provinsi').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('administrator.dewan.get-akun-dpp') !!}',
            ...
            columns: [
                ...
                { data: 'email_pengurus', name: 't_users_dp.email_pengurus' },
...
<script>
        $('#dewan-pengurus-provinsi').on('click','#remove-users-dpp', function (event) {
            event.preventDefault()
            const url = $(this).attr('data-id-users-dpp');
