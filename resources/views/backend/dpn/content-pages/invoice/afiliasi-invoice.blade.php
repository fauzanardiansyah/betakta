...
@section('title','Penerbitan Invoice Anggota Afiliasi')
@section('content-pages')
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Penerbitan Invoice Anggota Afiliasi</h2>
        ...
        <div class="x_content">
            <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                    <div class="col-sm-12">
                        <table id="invoice-agt-afiliasi" class="table" aria-describedby="datatable_info">
                            <thead>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                    <div class="col-sm-12">
                        <table id="show-invoice-agt-afiliasi-published" class="table" aria-describedby="datatable_info">
                            <thead>
                                    <th class="text-center">Nama Badan Usaha</th>
...
$(function() {
    $('#invoice-agt-afiliasi').DataTable({
        order: [[ 5, "desc" ]],
        processing: true,
        serverSide: true,
        ajax: '{!! route('dpn.invoice.get-afiliasi') !!}',
...
$(function() {
    $('#show-invoice-agt-afiliasi-published').DataTable({
        order: [[ 5, "desc" ]],
        processing: true,
        serverSide: true,
        ajax: '{!! route('dpn.invoice.get-publish-afiliasi') !!}',
    ...
    // Publish invoice afiliasi   
	$(document).ready(function(){
		$("#invoice-agt-afiliasi").on('click', '#publish-afiliasi-invoice',function(event){
			...
			$.ajax({
				type: 'POST',
				url: '{!! route('dpn.invoice.publish-afiliasi-invoice') !!}',
				...
				success: function(response) {
                    ...
                    console.log(response);
                        ...
                        $("#show-invoice-agt-afiliasi-published").DataTable().ajax.reload(null, false );
