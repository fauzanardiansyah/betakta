...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
                        ...
                        <div class="collapse" id="admin-bu">
                            <div class="card card-body">
                                ...
                                <table id="tablePreview" class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{!! (!empty($dataAdministrasiBu->alamat) ? $dataAdministrasiBu->alamat : 'Empty') !!}</td>
                                            <td>{!! (!empty($dataAdministrasiBu->kd_pos) ? $dataAdministrasiBu->kd_pos : 'Empty') !!} </td>
                                            <td>{!! (!empty($dataAdministrasiBu->kecamatan) ? $dataAdministrasiBu->kecamatan : 'Empty') !!}</td>
                                            <td>{!! (!empty($dataAdministrasiBu->kota) ? $dataAdministrasiBu->kota : 'Empty') !!} </td>
                                            <td>{!! (!empty($dataAdministrasiBu->no_telp) ? $dataAdministrasiBu->no_telp : 'Empty') !!}</td>
                                            <td>{!! (!empty($dataAdministrasiBu->no_fax) ? $dataAdministrasiBu->no_fa : 'Empty') !!}</td>
                                            <td>{!! (!empty($dataAdministrasiBu->website) ? $dataAdministrasiBu->website : 'Empty') !!}</td>
                                        </tr>
                                    </tbody>
                                    <!--Table body-->
                                </table>
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_ktp_pjbu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_foto_pjbu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_npwp_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_ijazah_pjbu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_akte_pendirian_perubahan_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_sk_pendirian_perubahan_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_skdp_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_siup]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_tdp]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->surat_permohonan_baru]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->surat_permohonan_perpanjang]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->surat_permohonan_daftar_ulang]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_nib]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.master-anggota.download', ['file_name' => $dataDokumen->file_kta]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
        ...
        <div class="x_title">
            @if($dataDokumen->status_pengajuan == 7 || $dataDokumen->status_pengajuan == 2 || $dataDokumen->status_pengajuan == 10 || $dataDokumen->status_pengajuan == 6 || $dataDokumen->status_pengajuan == 8) 
            {{-- @if($dataDokumen->status_pengajuan >= 2 )  --}}
            <a href="{{ url('/panel/dpn/master-anggota/anggota-baru') }}" class="btn btn-sm btn-primary pull-right"  title="Approve Documents" >Back</a>
            @else
            <a href="{{ route('dpn.master-anggota.approve', ['id_detail_kta' => $id_detail_kta, 'jenis_bu' => $dataDokumen->jenis_bu]) }}" data-url="" id="approve-dokumen-anggota" class="btn btn-sm btn-success pull-right"  title="Approve Documents" ><i class="glyphicon glyphicon glyphicon-saved"></i> Approve Dokumen</a>
            @endif
