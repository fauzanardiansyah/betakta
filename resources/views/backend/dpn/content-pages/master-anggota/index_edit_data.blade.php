...
@section('title','Master Perubahan Data')
@section('content-pages')
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Perubahan Data Anggota</h2>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Form Tolak Perubahan Data Anggota</h4>
            </div>
            <div class="modal-body">
              <h4>Masukan alasan kenapa di tolak</h4>
              <form action="{{ route('dpp.edit_data.reject') }}" method="POST" id="form-reject-document" class="form-horizontal" role="form">
                  @csrf
...
$(function() {
    $('#agt-pindah-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('dpn.get_data_anggota_edit') !!}',
