...
@section('title','Pindah DPP | Screening Document')
        ...
        <div class="x_content">
            <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                    <div class="col-sm-12">
                        <p>
                            ...
                            <button class="btn btn-warning" type="button" data-toggle="collapse"
                                data-target="#dokumen-pindah-bu" aria-expanded="false" aria-controls="collapseExample">
                                Dokumen Pindah DPP
                            </button>    
                            @endif
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_foto_pjbu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_npwp_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_akte_pendirian_perubahan_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_sk_pendirian_perubahan_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_skdp_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_siup]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_tdp]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_nib]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->file_kta]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                        ...
                        <div class="collapse" id="dokumen-pindah-bu">
                            <div class="card card-body">
                                <div class="col-md-12">
                                    <h4><strong>Keterangan Pindah DPP Dari Ke Anggotaaan Inkindo</strong></h4>
                                    ...
                                    <div class="thumbnail">
                                        <div class="image view view-first">
                                            ...
                                            <div class="mask">
                                                <p>{{ $dataDokumen->no_kta }}</p>
                                                <div class="tools tools-bottom">
                                                        <a href="#" class="show-file-pindah" file-name="{{ $dataDokumen->surat_permohonan }}" data-toggle="modal" data-target="#file-detail" title="Show file"><i class="fa fa-eye"></i></a>
                                                        <a href="{{ route('dpn.pindah.download', ['file_name' => $dataDokumen->surat_permohonan]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                </div>
                                            </div>
                                        </div>
                                        <div class="caption">
                                            <p>File Dokumen Pindah DPP</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
             ...
             <div class="x_title">
                ...
                <a href="{{ url('/panel/dpn/master-anggota/pindah_dpp') }}" class="btn btn-sm btn-primary pull-right"  title="Back" >Back</a>
                @else
                <a href=" {{ route('dpn.pindah.approve', ['id_detail_kta' => $dataDokumen->id_detail_kta]) }}" id="approve-dokumen-anggota" class="btn btn-sm btn-success pull-right"  title="Approve Documents" ><i class="glyphicon glyphicon glyphicon-saved"></i> Approve Dokumen</a>
                @endif
            </div>
        </div>
    </div>
