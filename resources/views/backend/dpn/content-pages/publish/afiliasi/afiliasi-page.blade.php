...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Penerbitan KTA Anggota Afiliasi</h2>
        ...
        <div class="x_content">
            <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                    <div class="col-sm-12">
                        <table id="anggota-afiliasi-final" class="table" aria-describedby="datatable_info">
                            <thead>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Masukan Nomor Kartu Tanda Anggota</h4>
            </div>
                    ...
                    <form class="form-horizontal form-label-left input_mask" id="publish-kta-afiliasi">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" id="no_kta" name="no_kta" value="" class="form-control"
...
<script>
$(function() {
    $('#anggota-afiliasi-final').DataTable({
        order: [[ 7, "desc" ]],
        processing: true,
        serverSide: true,
...
<script>
    ...
    $(document).ready(function(){
        $('#anggota-afiliasi-final').on('click', '#show-form-kta-afiliasi', function(){
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            text: Object.values(response),
                                ...
                                window.location = "/panel/dpn/publish-kta/afiliasi/penerbitan-afiliasi-kta";
                            });
                            $(this).trigger("reset");
                    },
