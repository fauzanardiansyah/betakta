...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Penerbitan Ulang KTA Anggota</h2>
        ...
        <div class="x_content">
            <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                    <div class="col-sm-12">
                        <table id="penerbitan-ulang-kta" class="table" aria-describedby="datatable_info">
                            <thead>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left input_mask" id="publish-kta-daftar-ulang">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" id="no_kta_baru" name="no_kta_baru" value="" class="form-control"
                                    placeholder="Input Nomor Kta Saat Ini">
                            </div>
                        </div>
...
<script>
$(function() {
    $('#penerbitan-ulang-kta').DataTable({
        order: [[ 7, "desc" ]],
        processing: true,
        serverSide: true,
        ajax: '{!! route('dpn.kta.get-daftar-ulang') !!}',
...
<script>
    ...
    $(document).ready(function(){
        $('#penerbitan-ulang-kta').on('click', '#show-form-kta-daftar-ulang', function(){
...
<script>
    //Publish KTA Afliasi
    $(document).ready(function(){
        $('#publish-kta-daftar-ulang').submit(function(event){
            ...
            $.ajax({
                    type: 'POST',
                    url: '{!! route('dpn.kta.daftar-ulang-publish') !!}',
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            text: Object.values(response),
                                ...
                                window.location = "/panel/dpn/publish-kta/daftar-ulang/penerbitan-ulang-kta";
                            });
                            $('#publish-kta-daftar-ulang').trigger("reset");
                    },
