...
@section('title','Report Anggota Inkindo ')
@section('content-pages')
<!-- Start Reports  DPP -->
<form id="generate_reports_dpn" class="form-horizontal form-label-left">

    <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Reports Dewan Pengurus Pusat</h2>
            ...
            <div class="x_content">
                ...
                <div class="">
                    <ul class="to_do">
                        ...
                        <li>
                            <p>
                                <input type="radio" name="jenis_report" id="pembayaran_role_share" value="4" class="flat"
                                    required> Pembayaran Role Sharing DPP</p>
                        </li>
                        <li>
                            <p>
                                <input type="radio" name="jenis_report" id="pembayaran_agt" value="5" class="flat"
                                    required> Pembayaran Anggota Afiliasi</p>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="col-md-16 col-sm-6 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jenis Pengajuan
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="jenis_pengajuan" class="form-control" required>
                            ...
                            <option value="4">Pemberhentian</option>
                            <option value="status_pengajuan">Sedang Diproses</option>
                        </select>
                    </div>
                </div> 
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kualifikasi Perusahaan 
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="report-table-dpn" class="table" aria-describedby="datatable_info">
                                <thead>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 " id="datatable-report-payments">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Master Reports Pembayaran Role Sharing</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="report-payments-roleshare-table-dpn" class="table" aria-describedby="datatable_info">
                                        <thead>
                                                <th class="text-center">No</th>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 " id="datatable-report-payments">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Master Reports Pembayaran Anggota Afiliasi</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="report-payments-afiliasi-table-dpn" class="table" aria-describedby="datatable_info">
                                        <thead>
                                                <th class="text-center">No</th>
                                                <th class="text-center">No Invoice</th>
                                                <th class="text-center">Nama Badan Usaha</th>
...
//For Export Buttons available inside jquery-datatable "server side processing" - End
        $('#generate_reports_dpn').submit(function(event){
            ...
            const provinsi     =  $('select[name="provinsi"] option:selected').val();
            const jenis_pengajuan =  $('select[name="jenis_pengajuan"] option:selected').val();
            const kualifikasi =  $('select[name="kualifikasi"] option:selected').val();
            ...
            if(jenis_report == 4) {
             $('#report-payments-roleshare-table-dpn').DataTable({
                ...
                columns: [
                    ...
                    { data: 'no_invoice', name: 't_role_share_confirmation.no_invoice' },
                    { data: 'nm_bu', name: 't_registrasi_users.nm_bu' },
                    { data: 'nominal', name: 't_role_share_confirmation.nominal' },
                    { data: 'created_at', name: 't_role_share_confirmation.created_at' },
                    { data: 'status_pembayaran', name: 't_invoice_role_share.status_pembayaran' },
                ]
            });
                
            
            } else if(jenis_report == 5) {
                $('#report-payments-afiliasi-table-dpn').DataTable({
                ...
                columns: [
                    ...
                    { data: 'no_invoice', name: 't_payments_confirmation.no_invoice' },
                    { data: 'nm_bu', name: 't_registrasi_users.nm_bu' },
                    { data: 'nominal', name: 't_payments_confirmation.nominal' },
                    { data: 'created_at', name: 't_payments_confirmation.created_at' },
