...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form action="{{ route('anggota.registration.administrasiBadanUsaha') }}" method="POST"
        class="form-horizontal form-label-left" id="simpan-data-bu">
        @csrf
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text"   name="no_fax" class="form-control" id="" value="{{ old('no_fax') }}" placeholder="No Fax">
        ...
        <div class="form-group">
          <div class="col-md-6 col-md-offset-3">
            <button  type="submit" name="simpan-data-bu" class="btn btn-success">Simpan Data Badan Usaha</button>
          </div>
        </div>
