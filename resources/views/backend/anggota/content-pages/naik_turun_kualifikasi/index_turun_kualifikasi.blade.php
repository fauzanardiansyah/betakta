...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>Formulir  Turun </h2>

      <div class="clearfix"></div>
    </div>
    <div class="x_content">

      <form action="{{ route('anggota.naik_turun_kualifikasi.form_badan_usaha_turun') }}" enctype="multipart/form-data"  method="POST"
      ...
      <div class="item form-group">
        ...
        <div class="form-group">
          <div class="col-md-6 col-md-offset-3">
            <a id="send" href="{{route('anggota.naik_turun_kualifikasi.form_badan_usaha_turun')}}" class="btn btn-sm btn-success">Proses Turun Kualifikasi</a>
          </div>
        </div>
