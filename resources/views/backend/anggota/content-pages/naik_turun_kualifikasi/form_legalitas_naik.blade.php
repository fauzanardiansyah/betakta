...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form action="{{ route('anggota.naik_turun_kualifikasi.form_dokumen_pendukung_naik') }}" enctype="multipart/form-data" method="POST"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_akte" value="{{ ( empty($dataUser->no_akte) ) ? "" : $dataUser->no_akte }}"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="nm_notaris" value="{{ ( empty($dataUser->nm_notaris) ) ? "" : $dataUser->nm_notaris }}"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_akte" value="{{ ( empty($dataUser->tgl_keluar_akte) ) ? "" : $dataUser->tgl_keluar_akte }}"
              id="w4-cc" required="">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <textarea name="maksud_tujuan_akte" class="form-control" id="" cols="30" rows="10" placeholder="Maksud dan tujuan badan usaha">{{ ( empty($dataUser->maksud_tujuan_akte) ) ? "" : $dataUser->maksud_tujuan_akte }}</textarea>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_sk_pendirian" value="{{ ( empty($dataUser->no_sk_pendirian) ) ? "" : $dataUser->no_sk_pendirian }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_sk_pendirian_keluar"
              value="{{ ( empty($dataUser->tgl_sk_pendirian_keluar) ) ? "" : $dataUser->tgl_sk_pendirian_keluar }}" placeholder="Masa Berlaku" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_skdp" value="{{ ( empty($dataUser->no_skdp) ) ? "" : $dataUser->no_skdp }}" placeholder="Nomor SKDP">
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="penerbit_skdp" value="{{ ( empty($dataUser->penerbit_skdp) ) ? "" : $dataUser->penerbit_skdp }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_skdp" value="{{ ( empty($dataUser->tgl_keluar_skdp) ) ? "" : $dataUser->tgl_keluar_skdp }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="masa_berlaku_skdp" value="{{ ( empty($dataUser->masa_berlaku_skdp) ) ? "" : $dataUser->masa_berlaku_skdp }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_siup" id="" value="{{ ( empty($dataUser->no_siup) ) ? "" : $dataUser->no_siup }}"
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Di Keluarkan Oleh</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" name="penerbit_siup" id="" value="{{ ( empty($dataUser->penerbit_siup) ) ? "" : $dataUser->penerbit_siup }}"
              placeholder="Di Keluarkan Oleh">
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Tanggal Di Keluarkan</label>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_siup" id="" value="{{ ( empty($dataUser->tgl_keluar_siup) ) ? "" : $dataUser->tgl_keluar_siup }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="masa_berlaku_siup" id=""
              value="{{ ( empty($dataUser->masa_berlaku_siup) ) ? "" : $dataUser->masa_berlaku_siup }}" placeholder="Masa Berlaku">
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_tdp" id="" value="{{ ( empty($dataUser->no_tdp) ) ? "" : $dataUser->no_tdp }}"
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Di Keluarkan Oleh</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" name="penerbit_tdp" id="" value="{{ ( empty($dataUser->penerbit_tdp) ) ? "" : $dataUser->penerbit_tdp }}"
              placeholder="Di Keluarkan Oleh" >
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Tanggal Di Keluarkan</label>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_tdp" id="" value="{{ ( empty($dataUser->tgl_keluar_tdp) ) ? "" : $dataUser->tgl_keluar_tdp }}"
              placeholder="Masa Berlaku">
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Masa Berlaku</label>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="masa_berlaku_tdp" id="" value="{{ ( empty($dataUser->masa_berlaku_tdp) ) ? "" : $dataUser->masa_berlaku_tdp }}"
              placeholder="Masa Berlaku">
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_nib" id="" value="{{ ( empty($dataUser->no_nib) ) ? "" : $dataUser->no_nib }}"
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Tanggal Di Keluarkan </label>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_nib" id="" value="{{ ( empty($dataUser->tgl_keluar_nib) ) ? "" : $dataUser->tgl_keluar_nib }}"
              placeholder="Masa Berlaku">
