...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form action="{{ route('anggota.naik_turun_kualifikasi.form_penanggung_jawab_naik') }}" method="POST"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" name="kecamatan" class="form-control" id="" value="{{ $dataUser->kecamatan }}" placeholder="Kecamatan" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" name="kota" class="form-control" id="" value="{{ $dataUser->kota }}" placeholder="Kota" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="number"  name="kd_pos" class="form-control" id="" value="{{ $dataUser->kd_pos }}" placeholder="Kode Pos" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="number" name="no_telp" class="form-control" id="" value="{{ $dataUser->no_telp }}" placeholder="No Telp" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="number"   name="no_fax" class="form-control" id="" value="{{ $dataUser->no_fax }}" placeholder="No Fax">
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" name="website" class="form-control" id="" value="{{ $dataUser->website }}" placeholder="Website">
