...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form action="{{ route('anggota.naik_turun_kualifikasi.form_legalitas_turun') }}" method="POST"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="nm_pjbu" id="w4-username" value="{{$dataUser->nm_pjbu}}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input name="nik" id="nik" class="form-control" placeholder="NIK" {{($dataUser->kewarganegaraan == 'wna')  ? "disabled" : "" }}
              ...
              type="number" maxlength="17" value="{{ $dataUser->nik }}" required />
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" name="passport" id="passport" class="form-control" value="{{ $dataUser->no_passport }}" {{($dataUser->kewarganegaraan == 'wni')  ? "disabled" : "" }}
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-username">Tempat, Tanggal Lahir<span
              class="required">*</span></label>
          <div class="col-sm-3">
            <input type="text" class="form-control" name="tempat" value="{{ $dataUser->tempat }}" placeholder="Tempat"
              required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" data-mask="0000-000-000-000" class="form-control" name="no_hp_pjbu"
              value="{{ $dataUser->no_hp_pjbu }}" placeholder="Nomor Handphone" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="email" class="form-control" name="email_pjbu" value="{{ $dataUser->email_pjbu }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" data-mask="00.000.000.0-000.000" max="16" class="form-control npwp" name="no_npwp_pjbu"
              value="{{ $dataUser->npwp_pjbu }}" placeholder="NPWP PJBU" required>
