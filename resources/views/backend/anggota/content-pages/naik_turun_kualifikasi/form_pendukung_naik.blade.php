...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form  action="{{ route('action_naik_kualifikasi') }}" method="POST" class="form-horizontal form-label-left forms-with-spinner"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            ...
            {!! $errors->first('file_ijazah_pjbu', '<p class="" style="margin-top:3px;padding:5px;background:#CE5454; color:cornsilk">:message</p>') !!}
          </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Lembar pengesahan & Perubahan (pdf, 8Mb)<span
              class="required">*</span></label>
          <div class="col-sm-9">
      ...
      {{--   <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Surat Permohonan Daftar Ulang KTA (pdf, 2Mb)<span
            class="required">*</span></label>
          <div class="col-sm-9">
            <input type="file" class="form-control" name="surat_permohonan_daftar_ulang" id="" required>
            {!! $errors->first('surat_permohonan_daftar_ulang', '<p class="" style="margin-top:3px;background:#CE5454; color:cornsilk;padding:5px">:message</p>') !!}
          </div>
        </div>

        <div class="item form-group">
            <label class="col-sm-3 control-label" for="w4-first-name">KTA Saat Ini (pdf, 2Mb)<span
              class="required">*</span></label>
            <div class="col-sm-9">
              <input type="file" class="form-control" name="file_kta" id="" required>
