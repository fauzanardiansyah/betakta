...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form action="{{ route('anggota.naik_turun_kualifikasi.form_badan_usaha_naik') }}" enctype="multipart/form-data"  method="POST"
      ...
      <div class="item form-group">
        ...
        <div class="form-group">
          <div class="col-md-6 col-md-offset-3">
            <a id="send" href="{{route('anggota.naik_turun_kualifikasi.form_badan_usaha_naik')}}" class="btn btn-sm btn-success">Proses Naik Kualifikasi</a>
          </div>
        </div>
