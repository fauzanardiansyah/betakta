        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Form Tolak Naik Kualifikasi</h4>
            </div>
            <div class="modal-body">
              <h4>Masukan alasan kenapa di tolak</h4>
              <form action="{{ route('dpp.naik_kualifikasi.reject') }}" method="POST" id="form-reject-document" class="form-horizontal" role="form">
                  @csrf
...
$(function() {
    $('#agt-pindah-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('dpp.get_data_naik_kualifikasi') !!}',
