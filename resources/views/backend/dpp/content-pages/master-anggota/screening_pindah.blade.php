    ...
    <div class="x_panel">
        ...
        <div class="x_content">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_foto_pjbu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_npwp_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_akte_pendirian_perubahan_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_sk_pendirian_perubahan_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_skdp_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_siup]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_tdp]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_nib]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->file_kta]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                        ...
                                        <div class="image view view-first">
                                            ...
                                            <div class="mask">
                                                ...
                                                <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pindah.download', ['file_name' => $dataDokumen->surat_permohonan]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                </div>
                                            </div>
                                        </div>
                                        <div class="caption">
            ...
            <div class="x_title">
                    ...
                    @if($dataDokumen->status_pengajuan == 11 ) 
                    <a href=" {{ route('dpp.pindah.approve', ['id_detail_kta' => $dataDokumen->id_detail_kta]) }}" id="approve-dokumen-anggota" class="btn btn-sm btn-success pull-right"  title="Approve Documents" ><i class="glyphicon glyphicon glyphicon-saved"></i> Approve Dokumen</a>
                    @elseif($dataDokumen->status_pengajuan >= 2 ) 
                    <a href="{{ url('/panel/dpp/master-anggota/pindah_dpp') }}" class="btn btn-sm btn-primary pull-right"  title="Back" >Back</a>
                    @else
                    <a href=" {{ route('dpp.pindah.approve', ['id_detail_kta' => $dataDokumen->id_detail_kta]) }}" id="approve-dokumen-anggota" class="btn btn-sm btn-success pull-right"  title="Approve Documents" ><i class="glyphicon glyphicon glyphicon-saved"></i> Approve Dokumen</a>
                    @endif
                </div>
