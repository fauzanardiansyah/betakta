...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_foto_pjbu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_npwp_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_akte_pendirian_perubahan_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_sk_pendirian_perubahan_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_skdp_bu]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_siup]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_tdp]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_nib]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="image view view-first">
                                                ...
                                                <div class="mask">
                                                    ...
                                                    <div class="tools tools-bottom">
                                                        ...
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataDokumen->file_kta]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                        ...
                        <div class="collapse" id="dokumen-pemberhentian-bu">
                            <div class="card card-body">
                                <div class="col-md-12">
                                    ...
                                    <p>{{ $dataPemberhentian->keterangan }}</p>
                                </div>
                                <div class="col-md-55">
                                    <div class="thumbnail">
                                        <div class="image view view-first">
                                            ...
                                            <div class="mask">
                                                <p>{{ $dataDokumen->no_kta }}</p>
                                                <div class="tools tools-bottom">
                                                        <a href="#" class="show-file-pemberhentian" file-name="{{ $dataPemberhentian->file_pemberhentian }}" data-toggle="modal" data-target="#file-detail" title="Show file"><i class="fa fa-eye"></i></a>
                                                        <a href="{{ route('dpp.pemberhentian.download', ['file_name' => $dataPemberhentian->file_pemberhentian]) }}" title="Download File"><i class="fa fa-download"></i></a>                         
                                                </div>
                                            </div>
                                        </div>
                                        <div class="caption">
        ...
        <div class="x_title">
            ...
            <a href="{{ url('/panel/dpp/master-anggota/anggota-berhenti') }}" class="btn btn-sm btn-primary pull-right"  title="Approve Documents" >Back</a>
            @else
            <a href=" {{ route('dpp.pemberhentian.approve', ['id_detail_kta' => $id_detail_kta]) }}" id="approve-dokumen-anggota" class="btn btn-sm btn-success pull-right"  title="Approve Documents" ><i class="glyphicon glyphicon glyphicon-saved"></i> Approve Dokumen</a>
            @endif
        </div>
    </div>
</div>
