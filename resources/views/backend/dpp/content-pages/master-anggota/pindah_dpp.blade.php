...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Master Anggota Pindah DPP</h2>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="{{ route('dpp.pindah.reject') }}" method="POST" id="form-reject-document" class="form-horizontal" role="form">
                  @csrf
...
$(function() {
    $('#agt-pindah-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('dpp.get_data_anggota_pindah') !!}',
