              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-user"></i> Master Anggota <span class="fa fa-chevron-right"></span></a>
                  <ul class="nav child_menu" style="display: none;">
                    ...
                    <li><a href="{{ route('dpp.pindah_dpp') }}">Pindah DPP</a></li>
                    <li><a href="{{ route('dpp.naik_kualifikasi') }}">Naik Kualifikasi</a></li>
                    <li><a href="{{ route('dpp.turun_kualifikasi') }}">Turun Kualifikasi</a></li>
                    <li><a href="{{ route('dpp.index_edit_data') }}">Perubahan Data</a></li>
                  </ul>
                </li>
