                        ...
                        <section class="content invoice">
                            ...
                            <div class="row">
                                <div class="col-xs-12 invoice-header">
                                    <h1>
                                        <a>
                                            <img src="{{ public_path('backend/kta-assets/logo-invoice.png') }}"
                                                style="width:180px; max-width:300px; margin-bottom:10px;">
                                        </a>
                                        
                                                @if ($dataInvoiceRoleShare['invoice']->status_pembayaran == 0)
                                                <img src="{{ public_path('backend/kta-assets/UNPAID.png') }}" class="watermarked pull-right" alt=""> 
                                                @endif
                                                @if ($dataInvoiceRoleShare['invoice']->status_pembayaran == 1)
                                                <img src="{{ public_path('backend/kta-assets/Paid.png') }}" class="watermarked pull-right" alt=""> 
                                                @endif
                            ...
                            <div class="row invoice-info">
                                <div class="col-sm-4 col-xs-4 invoice-col">
                                    From
                                    <address>
                                        <strong>Dewan Pengurus Nasional Ikatan Nasional Konsultan Indonesia</strong>
                                ...
                                <div class="col-sm-4 col-xs-4 invoice-col">
                                    To
                                    <address>
                                        <strong>Dewan Pengurus Provinsi {!! $dataInvoiceRoleShare['kta']->nama_provinsi !!}</strong>
                                        ...
                                        <tbody>
                                            <tr id="r1">
                                                ...
                                                <td>
                                                        ...
                                                        Perpanjangan
                                                        @elseif($dataInvoiceRoleShare['invoice']->jenis_pengajuan == 6)
                                                        Naik Kualifikasi
                                                        @endif 
                                                </td>
                                                <td> @if($dataInvoiceRoleShare['invoice']->jenis_pengajuan == 6)
                                                    ...
                                                    @else 
                                                        ...
                                                        {!! $dataInvoiceRoleShare['kta']->kualifikasi !!}
                                                    @endif
                                                </td>
                                            ...
                                            <tr id="r2">
                                                    <td>2</td>
                                                    <td>Iuran Keanggotaan untuk bulan : <br>
                                                        @if ($dataInvoiceRoleShare['invoice']->jenis_pengajuan == 0 )
                                                            @php 
                                                    ...
                                                    <td>
                                                        @if($dataInvoiceRoleShare['invoice']->jenis_pengajuan == 6)
                                                    ...
                                                    <td>
                                                        @if($dataInvoiceRoleShare['invoice']->jenis_pengajuan == 6)
                                                            ...
                                                            @if ($dataInvoiceRoleShare['kta']->kualifikasi == 'kecil')
                                                                @php
                                                                    $tag = ($dataInvoiceRoleShare['dpp']->iuran_1_thn_menengah /12)*12;
                                                                    $tot = ($tag * $dataInvoiceRoleShare['dpp']->role_share_iuran_menengah) /100;
                                                                @endphp
                                                                IDR. {!! number_format(($tot)) !!} 
                                                            @elseif($dataInvoiceRoleShare['kta']->kualifikasi == 'menengah')
                                                                @php
                                                                    $tag = ($dataInvoiceRoleShare['dpp']->iuran_1_thn_besar /12)*12;
                                                                    $tot = ($tag * $dataInvoiceRoleShare['dpp']->role_share_iuran_besar) /100;
                                                                @endphp
                                                                IDR. {!! number_format(($tot)) !!} 
                                                            @endif
                                                            ...
                                                            IDR. {!! number_format($dataInvoiceRoleShare['invoice']->total_role_share) !!} 
                                                    ...
                                                    <td>
                                                         @if($dataInvoiceRoleShare['invoice']->jenis_pengajuan == 6)
                                                            IDR. {!! number_format($dataInvoiceRoleShare['invoice']->jml_tagihan_naik) !!}
                                                        @else
                                                            @if($dataInvoiceRoleShare['kta']->kualifikasi == 'kecil')
                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    <p class="" style="font-weight: bold;font-size:15px;">Metode Pembayaran:</p>
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <div class="table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td ><strong>
                                                        @if($dataInvoiceRoleShare['invoice']->jenis_pengajuan == 6)
                                                            IDR. {!! number_format($dataInvoiceRoleShare['invoice']->jml_tagihan_naik) !!}
                                                        @else
                                                            IDR.{!! number_format($dataInvoiceRoleShare['invoice']->total_role_share) !!}</strong>
                                                        @endif
                                                        </strong>
                                                    </td>
                                                </tr>
                                        ...
                                        <div id="qr" style="padding-top:30px; padding-left:60px">
                                                <img src="data:image/png;base64,{{DNS2D::getBarcodePNG(url('panel/dpn/invoice/invoice-role-share-showing/'.$dataInvoiceRoleShare['invoice']->no_invoice.'/'.$dataInvoiceRoleShare['kta']->id_detail_kta), "QRCODE", 3,3)}}" alt="barcode" />
                                        </div>
                                        </div>
                                </div>
