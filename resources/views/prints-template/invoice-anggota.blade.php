                        ...
                        <section class="content invoice">
                                                    ...
                                                    @if ($dataInvoiceAnggota['kta']->jenis_bu == 'pmdn')
                                                        ...
                                                        Iuran Keanggotaan untuk bulan : <br>
                                                            ...
                                                            @elseif($dataInvoiceAnggota['invoice']->jenis_pengajuan == 6)
                                                                ...
                                                                {{-- {!! number_format($dataInvoiceAnggota['invoice']->jml_tagihan_naik) !!}  --}}
                                                            @endif
                                                    @else
                                                    ...
                                                    @if ($dataInvoiceAnggota['kta']->jenis_bu == 'pmdn')
                                                        ...
                                                        @endphp
                                                                ...
                                                                @if($dataInvoiceAnggota['invoice']->jenis_pengajuan == 0)
                                                                    @if ($dataInvoiceAnggota['kta']->kualifikasi == 'kecil')
                                                                        @php 
                                                                        $iuran_bagi_kecil = $dataInvoiceAnggota['pengurus']->iuran_1_thn_kecil / 12;
                                                                        $v_iuran = $iuran_bagi_kecil * $timeDiff;
                                                                        @endphp
                                                                        <br>
                                                                        IDR. {!! number_format($iuran_bagi_kecil * $timeDiff) !!} <br>
                                                                        @if($month_cut < $get_month_now)
                                                                            IDR.
                                                                            @php 
                                                                               echo number_format($iuran_bagi_kecil * 12);
                                                                               $price_cut =$iuran_bagi_kecil * 12;
                                                                            @endphp
                                                                    ...
                                                                    @elseif($dataInvoiceAnggota['kta']->kualifikasi == 'menengah')
                                                                        @php 
                                                                        $iuran_bagi_menengah = $dataInvoiceAnggota['pengurus']->iuran_1_thn_menengah / 12;
                                                                        $v_iuran = $iuran_bagi_menengah * $timeDiff;
                                                                        @endphp
                                                                        <br>
                                                                        IDR. {!! number_format( $iuran_bagi_menengah  * $timeDiff) !!}  <br>
                                                                        @if($month_cut < $get_month_now)
                                                                            IDR.
                                                                            @php 
                                                                                echo number_format($iuran_bagi_menengah * 12);
                                                                               $price_cut =$iuran_bagi_menengah * 12;
                                                                            @endphp
                                                                        @endif
                                                                
                                                                    @elseif($dataInvoiceAnggota['kta']->kualifikasi == 'besar')
                                                                        @php
                                                                            $iuran_bagi_besar = $dataInvoiceAnggota['pengurus']->iuran_1_thn_besar / 12;
                                                                            $v_iuran = $iuran_bagi_besar * $timeDiff;
                                                                        @endphp
                                                                        IDR. {!! number_format( $iuran_bagi_besar * $timeDiff) !!}   <br>
                                                                        @if($month_cut < $get_month_now)
                                                                            IDR.
                                                                            @php 
                                                                                echo number_format($iuran_bagi_besar * 12);
                                                                               $price_cut =$iuran_bagi_besar * 12;
                                                                            @endphp
                                                                        @endif
                                                                    @endif
                                                                ...
                                                                @elseif($dataInvoiceAnggota['invoice']->jenis_pengajuan == 1)
                                                                    ...
                                                                    @if ($dataInvoiceAnggota['kta']->kualifikasi == 'kecil')
                                                                        ...
                                                                        IDR. {!! number_format($iuran_bagi_kecil * $timeDiff) !!} 
                                                                        @if($month_cut < $get_month_now)
                                                                            IDR.
                                                                            @php 
                                                                               echo number_format($iuran_bagi_kecil * 12);
                                                                    ...
                                                                    @elseif($dataInvoiceAnggota['kta']->kualifikasi == 'menengah')
                                                                        ...
                                                                        IDR. {!! number_format( $iuran_bagi_menengah  * $timeDiff) !!}  
                                                                        @if($month_cut < $get_month_now)
                                                                            IDR.
                                                                            @php 
                                                                                echo number_format($iuran_bagi_menengah * 12);
                                                                    ...
                                                                    @elseif($dataInvoiceAnggota['kta']->kualifikasi == 'besar')
                                                                        @php
                                                                            ...
                                                                            $v_iuran = $iuran_bagi_besar * $timeDiff;
                                                                        @endphp
                                                                        IDR. {!! number_format( $iuran_bagi_besar * $timeDiff) !!}   
                                                                        @if($month_cut < $get_month_now)
                                                                            IDR.
                                                                            @php 
                                                                                echo number_format($iuran_bagi_besar * 12);
                            ...
                            <div class="row bottom-row">
                                <div class="col-xs-8">
                                    ...
                                    <div class="text-muted well well-sm no-shadow rek" style="margin-top: 1px;">
