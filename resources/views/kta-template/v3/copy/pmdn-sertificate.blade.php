...
<body>
    <div class="ikindo big-container" id="ikindo">
        <img src="{{ asset('assets-kta/ktaV3/') }}/assets/rectangle.png" class="bg-rectagle-top rectagle-big-top" width="100px" height="100px">
        ...
        <div class="content-wrapper">
            <div class="block-header">
                <table style="width: 100%;">
                    <tr>
                        <td width="30%" class="text-left"><img style="width: 110px;height: 110px" class="company-logo" src="{{ asset('assets-kta/ktaV3/') }}/assets/logo.png"></td>
                        ...
                        <td width="30%" class="text-right">
                            <?php echo '<img style="width:200px;height:50px" src="data:image/png;base64,' . DNS1D::getBarcodePNG($dataKta->npwp_bu, "C128B",1,65) . '"  alt="barcode"   />'; ?>
                            <br>{{ implode(' ',str_split($dataKta->npwp_bu)) }}
                        </td>
                    </tr>
                </table>
            </div>
            <div class="block-identity">
                        ...
                        <td width="75%">
                            <table style="width: 100%;" class="table-identity">
                                ...
                                <tr>
                                    ...
                                    <td width="5%">:</td>
                                    <td width="65%">{!! str_limit(strtoupper($dataKta->nm_bu), 100, ',') !!}</td>
                                </tr>
                                <tr>
                                    <td width="30%">Alamat</td>
                                    <td width="5%">:</td>
                                    <td width="65%">{!! str_limit(ucwords($dataKta->alamat), 100,",") !!} Kecamatan {!! ucwords($dataKta->kecamatan) !!}, {!! ucwords($dataKta->kota) !!}</td>
                                </tr>
                                <tr>
                ...
                <p class="label-blue text-semi-bold margin-auto space-16-bottom">{{ $result = ($dataKta->status_bu == "pusat" OR $dataKta->status_bu == "Pusat") ? "PENUH" : "TERBATAS" }}</p>
            ...
            <table style="width: 100%;">
                <tr>
                    <td width="35%" colspan="2">
                        <p class="text-semi-bold text-center">Dewan Pengurus
                            Provinsi {{ $dataKta->province_name }}</p>
                    </td>
                    <td width="30%"></td>
                    <td width="35%" colspan="2">
                        <p class="text-semi-bold text-center">Disahkan dan diregistrasi</p>
                        <p class="text-semi-bold text-center">Jakarta, {!! App\Helpers\LocalDate::toIndonesia($dataKta->tgl_terbit) !!}</p>
                        <p class="text-semi-bold text-center">Dewan Pengurus Nasional</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <img class="img-responsive margin-auto space-60-minus-bottom signature" style="width: 60px; margin-top:-20px" src="{{ asset('storage/signature/'.$dataKta->ttd_ketua_provinsi) }}">
                        <p class="text-semi-bold text-center">{!! $dataKta->nm_ketua_provinsi  !!}</p>
                        <p class="text-center">Ketua</p>
                    </td>
                    <td>
                        <img class="img-responsive margin-auto space-60-minus-bottom signature" style="width: 60px; margin-top:-20px" src="{{ asset('storage/signature/'.$dataKta->ttd_sekretaris_provinsi) }}">
                        <p class="text-semi-bold text-center">{!! $dataKta->nm_sekretaris_provinsi  !!}</p>
