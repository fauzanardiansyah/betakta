...
Route::group(['prefix' => '/panel/anggota', 'middleware' => ['prevent_user']], function () {
    ...
    Route::get('edit_data/1', 'Backend\Anggota\EditDataAnggotaController@formAdminstrasiBadanUsaha')->name('anggota.edit_data.formAdministrasiBadanUsaha');
    Route::get('edit_data/2', 'Backend\Anggota\EditDataAnggotaController@formPenanggungJawabBadanUsaha')->name('anggota.edit_data.formPenanggungJawabBadanUsaha');
    Route::get('edit_data/3', 'Backend\Anggota\EditDataAnggotaController@formLegalitasBadanUsaha')->name('anggota.edit_data.formLegalitasBadanUsaha');
    Route::get('edit_data/4', 'Backend\Anggota\EditDataAnggotaController@formDokumenPendukung')->name('anggota.edit_data.formUploadDokumenPendukung');

    Route::post('edit_data/info-umum-bu', 'Backend\Anggota\EditDataAnggotaController@infoUmumBadanUsaha')->name('anggota.edit_data.infoUmumBadanUsaha');
    Route::post('edit_data/administrasi-bu', 'Backend\Anggota\EditDataAnggotaController@administrasiBadanUsaha')->name('anggota.edit_data.administrasiBadanUsaha');
    Route::post('edit_data/penanggung-jawab-bu', 'Backend\Anggota\EditDataAnggotaController@penanggungJawabBadanUsaha')->name('anggota.edit_data.penanggungJawabBadanUsaha');
    Route::post('edit_data/legalitas-bu', 'Backend\Anggota\EditDataAnggotaController@legalitasBadanUsaha')->name('anggota.edit_data.legalitasBadanUsaha');
    Route::post('edit_data/dokumen-pendukung', 'Backend\Anggota\EditDataAnggotaController@dokumenPendukung')->name('anggota.edit_data.dokumen');
    ...
    Route::get('pindah_dpp', 'Backend\Anggota\PindahDppController@index')->name('pindah_dpp');
    Route::post('action_pindah_dpp', 'Backend\Anggota\PindahDppController@action_pindah_dpp')->name('action_pindah_dpp');
  ...
  #========== naik turun kualifikasi ---- naik ----- ========
        Route::get('naik_kualifikasi', 'Backend\Anggota\NaikTurunKualifikasiController@index_naik_kualifikasi')->name('index_naik_kualifikasi');
        


        Route::get('naik_kualifikasi/1', 'Backend\Anggota\NaikTurunKualifikasiController@form_badan_usaha_naik')->name('anggota.naik_turun_kualifikasi.form_badan_usaha_naik');
        Route::post('naik_kualifikasi/2', 'Backend\Anggota\NaikTurunKualifikasiController@form_penanggung_jawab_naik')->name('anggota.naik_turun_kualifikasi.form_penanggung_jawab_naik');
        Route::post('naik_kualifikasi/3', 'Backend\Anggota\NaikTurunKualifikasiController@form_legalitas_naik')->name('anggota.naik_turun_kualifikasi.form_legalitas_naik');
        Route::post('naik_kualifikasi/4', 'Backend\Anggota\NaikTurunKualifikasiController@form_dokumen_pendukung_naik')->name('anggota.naik_turun_kualifikasi.form_dokumen_pendukung_naik');
        Route::post('action_naik_kualifikasi', 'Backend\Anggota\NaikTurunKualifikasiController@action_naik_kualifikasi')->name('action_naik_kualifikasi');
           
    #================= # ==========

  #========== naik turun kualifikasi ---- turun ----- ========
        Route::get('turun_kualifikasi', 'Backend\Anggota\NaikTurunKualifikasiController@index_turun_kualifikasi')->name('index_turun_kualifikasi');


        Route::get('turun_kualifikasi/1', 'Backend\Anggota\NaikTurunKualifikasiController@form_badan_usaha_turun')->name('anggota.naik_turun_kualifikasi.form_badan_usaha_turun');
        Route::post('turun_kualifikasi/2', 'Backend\Anggota\NaikTurunKualifikasiController@form_penanggung_jawab_turun')->name('anggota.naik_turun_kualifikasi.form_penanggung_jawab_turun');
        Route::post('turun_kualifikasi/3', 'Backend\Anggota\NaikTurunKualifikasiController@form_legalitas_turun')->name('anggota.naik_turun_kualifikasi.form_legalitas_turun');
        Route::post('turun_kualifikasi/4', 'Backend\Anggota\NaikTurunKualifikasiController@form_dokumen_pendukung_turun')->name('anggota.naik_turun_kualifikasi.form_dokumen_pendukung_turun');
        Route::post('action_turun_kualifikasi', 'Backend\Anggota\NaikTurunKualifikasiController@action_turun_kualifikasi')->name('action_turun_kualifikasi');
    ...
    Route::get('download/download_kta/{idKta}', 'Backend\Anggota\DownloadKtaController@download_kta')->name('anggota.download_kta');
...
Route::group(['prefix' => '/panel/dpp', 'middleware' => ['prevent_council']], function () {
    ...
    Route::group(['prefix' => 'master-anggota'], function () {
        ...
        Route::get('index_edit_data', 'Backend\Dpp\Edit\DataAnggotaController@index_edit_data')->name('dpp.index_edit_data');
        Route::get('get_data_anggota_edit', 'Backend\Dpp\Edit\DataAnggotaController@get_data_anggota_edit')->name('dpp.get_data_anggota_edit');
        Route::get('screen/document/anggota/edit_data/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ScreeningDocumentController@showDocumentEditData')->name('dpp.edit_data.screening') ;

        Route::get('edit_data/dokumen/approve/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ApprovalAnggotaDokumenController@approveDokumenEditData')->name('dpp.edit_data.approve');
        Route::post('edit_data/dokumen/reject', 'Backend\Dpp\MasterAnggota\ApprovalAnggotaDokumenController@rejectDokumenEditData')->name('dpp.edit_data.reject');
        #================



    #========== pindah dpp ========
        Route::get('pindah_dpp', 'Backend\Dpp\MasterAnggota\MasterAnggotaController@pindah_dpp')->name('dpp.pindah_dpp');
        Route::get('get_data_anggota_pindah', 'Backend\Dpp\MasterAnggota\MasterAnggotaController@get_data_anggota_pindah')->name('dpp.get_data_anggota_pindah');
        Route::get('screen/document/anggota/pindah/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ScreeningDocumentController@showDocumentPindahAnggota')->name('dpp.pindah.screening') ;
        Route::get('pindah/dokumen/approve/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ApprovalAnggotaDokumenController@approveDokumenPindah')->name('dpp.pindah.approve');
        Route::post('pindah/dokumen/reject', 'Backend\Dpp\MasterAnggota\ApprovalAnggotaDokumenController@rejectDokumenPindah')->name('dpp.pindah.reject');
        Route::get('screen/document/anggota/download/pindah/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ScreeningDocumentController@downloadFileDocumentPindah')->name('dpp.pindah.download');
           
    #================= # ==========

        Route::post('anggota-baru/master-anggota/delete_pengajuan', 'Backend\Dpp\MasterAnggota\MasterAnggotaController@deletePengajuan')->name('dpp.master-anggota.delete_pengajuan');
    ...
    Route::get('download/idcard/{idKta}', 'Backend\Dpp\Download\DownloadKtaController@DownloadProcess')->name('dpp.process-download-idcard');
     ...
     #========== naik turun kualifikasi ---- naik ----- ========
        Route::get('naik_kualifikasi', 'Backend\Dpp\MasterAnggota\MasterAnggotaController@naik_kualifikasi')->name('dpp.naik_kualifikasi');
        Route::get('get_data_naik_kualifikasi', 'Backend\Dpp\MasterAnggota\MasterAnggotaController@get_data_naik_kualifikasi')->name('dpp.get_data_naik_kualifikasi');
        Route::get('screen/document/anggota/naik_kualifikasi/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ScreeningDocumentController@showDocumentNaikKualifikasi')->name('dpp.naik_kualifikasi.screening') ;
        Route::get('naik_kualifikasi/dokumen/approve/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ApprovalAnggotaDokumenController@approveDokumenNaikKualifikasi')->name('dpp.naik_kualifikasi.approve');
        Route::post('naik_kualifikasi/dokumen/reject', 'Backend\Dpp\MasterAnggota\ApprovalAnggotaDokumenController@rejectDokumenNaikKualifikasi')->name('dpp.naik_kualifikasi.reject');
    ...
    #================= # ==========
     ...
     #========== naik turun kualifikasi ---- turun ----- ========
        Route::get('turun_kualifikasi', 'Backend\Dpp\MasterAnggota\MasterAnggotaController@turun_kualifikasi')->name('dpp.turun_kualifikasi');
        Route::get('turun_kualifikasi', 'Backend\Dpp\MasterAnggota\MasterAnggotaController@turun_kualifikasi')->name('dpp.turun_kualifikasi');
        Route::get('get_data_turun_kualifikasi', 'Backend\Dpp\MasterAnggota\MasterAnggotaController@get_data_turun_kualifikasi')->name('dpp.get_data_turun_kualifikasi');
        Route::get('screen/document/anggota/turun_kualifikasi/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ScreeningDocumentController@showDocumentTurunKualifikasi')->name('dpp.turun_kualifikasi.screening') ;
        Route::get('turun_kualifikasi/dokumen/approve/{id_detail_kta}', 'Backend\Dpp\MasterAnggota\ApprovalAnggotaDokumenController@approveDokumenTurunKualifikasi')->name('dpp.turun_kualifikasi.approve');
        Route::post('turun_kualifikasi/dokumen/reject', 'Backend\Dpp\MasterAnggota\ApprovalAnggotaDokumenController@rejectDokumenTurunKualifikasi')->name('dpp.turun_kualifikasi.reject');
...
Route::group(['prefix' => '/panel/dpn', 'middleware' => ['prevent_dpn']], function () {
    ...
    #========== pindah dpp ========
        Route::get('pindah_dpp', 'Backend\Dpn\MasterAnggota\MasterAnggotaController@pindah_dpp')->name('dpn.pindah_dpp');
        Route::get('get_data_anggota_pindah', 'Backend\Dpn\MasterAnggota\MasterAnggotaController@get_data_anggota_pindah')->name('dpn.get_data_anggota_pindah');
        Route::get('screen/document/anggota/pindah/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ScreeningDocumentController@showDocumentPindahAnggota')->name('dpn.pindah.screening') ;
        Route::get('pindah/dokumen/approve/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ApprovalAnggotaDokumenController@approveDokumenPindah')->name('dpn.pindah.approve');
        Route::post('pindah/dokumen/reject', 'Backend\Dpn\MasterAnggota\ApprovalAnggotaDokumenController@rejectDokumenPindah')->name('dpn.pindah.reject');
        Route::get('screen/document/anggota/download/pindah/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ScreeningDocumentController@downloadFileDocumentPindah')->name('dpn.pindah.download');
    ...
    Route::get('index_edit_data', 'Backend\Dpn\Edit\DataAnggotaController@index_edit_data')->name('dpn.index_edit_data');
    Route::get('get_data_anggota_edit', 'Backend\Dpn\Edit\DataAnggotaController@get_data_anggota_edit')->name('dpn.get_data_anggota_edit');
    Route::get('screen/document/anggota/edit_data/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ScreeningDocumentController@showDocumentEditData')->name('dpn.edit_data.screening') ;

    Route::get('edit_data/dokumen/approve/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ApprovalAnggotaDokumenController@approveDokumenEditData')->name('dpn.edit_data.approve');
    Route::post('edit_data/dokumen/reject', 'Backend\Dpn\MasterAnggota\ApprovalAnggotaDokumenController@rejectEditData')->name('dpn.edit_data.reject');

      #========== naik turun kualifikasi ---- naik ----- ========
        Route::get('naik_kualifikasi', 'Backend\Dpn\MasterAnggota\MasterAnggotaController@naik_kualifikasi')->name('dpn.naik_kualifikasi');
        Route::get('get_data_naik_kualifikasi', 'Backend\Dpn\MasterAnggota\MasterAnggotaController@get_data_naik_kualifikasi')->name('dpn.get_data_naik_kualifikasi');
        Route::get('screen/document/anggota/naik_kualifikasi/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ScreeningDocumentController@showDocumentNaikKualifikasi')->name('dpn.naik_kualifikasi.screening') ;
        Route::get('naik_kualifikasi/dokumen/approve/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ApprovalAnggotaDokumenController@approveDokumenNaikKualifikasi')->name('dpn.naik_kualifikasi.approve');
        Route::get('naik_kualifikasi/dokumen/reject', 'Backend\Dpn\MasterAnggota\ApprovalAnggotaDokumenController@rejectDokumenNaikKualifikasi')->name('dpn.naik_kualifikasi.reject');
    ...
    #================= # ==========
     ...
     #========== naik turun kualifikasi ---- turun ----- ========
        Route::get('turun_kualifikasi', 'Backend\Dpn\MasterAnggota\MasterAnggotaController@turun_kualifikasi')->name('dpn.turun_kualifikasi');
        Route::get('get_data_turun_kualifikasi', 'Backend\Dpn\MasterAnggota\MasterAnggotaController@get_data_turun_kualifikasi')->name('dpn.get_data_turun_kualifikasi');
        Route::get('screen/document/anggota/turun_kualifikasi/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ScreeningDocumentController@showDocumentTurunKualifikasi')->name('dpn.turun_kualifikasi.screening') ;
        Route::get('turun_kualifikasi/dokumen/approve/{id_detail_kta}', 'Backend\Dpn\MasterAnggota\ApprovalAnggotaDokumenController@approveDokumenTurunKualifikasi')->name('dpn.turun_kualifikasi.approve');
        Route::get('turun_kualifikasi/dokumen/reject', 'Backend\Dpn\MasterAnggota\ApprovalAnggotaDokumenController@rejectDokumenTurunKualifikasi')->name('dpn.turun_kualifikasi.reject');
