...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form action="{{ route('anggota.registration.legalitasBadanUsaha') }}" method="POST"
        class="form-horizontal form-label-left" id="simpan-legalitas-bu">
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_akte" value="{{ old('no_akte') }}"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="nm_notaris" value="{{ old('nm_notaris') }}"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_akte" value="{{ old('tgl_keluar_akte') }}"
              id="w4-cc" required="">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <textarea name="maksud_tujuan_akte" class="form-control" id="" cols="30" rows="10" placeholder="Maksud dan tujuan badan usaha">{{ old('maksud_tujuan_akte') }}</textarea>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_sk_pendirian" value="{{ old('no_sk_pendirian') }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_sk_pendirian_keluar"
              value="{{ old('tgl_sk_pendirian_keluar') }}" placeholder="Masa Berlaku" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_skdp" value="{{ old('no_skdp') }}" placeholder="Nomor SKDP">
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="penerbit_skdp" value="{{ old('penerbit_skdp') }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_skdp" value="{{ old('tgl_keluar_skdp') }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="masa_berlaku_skdp" value="{{ old('masa_berlaku_skdp') }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_siup" id="" value="{{ old('no_siup') }}"
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Di Keluarkan Oleh</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" name="penerbit_siup" id="" value="{{ old('penerbit_siup') }}"
              placeholder="Di Keluarkan Oleh">
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Tanggal Di Keluarkan</label>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_siup" id="" value="{{ old('tgl_keluar_siup') }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-3">
            <input type="date" class="form-control" name="masa_berlaku_siup" id=""
              value="{{ old('masa_berlaku_siup') }}" placeholder="Masa Berlaku">
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_tdp" id="" value="{{ old('no_tdp') }}"
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Di Keluarkan Oleh</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" name="penerbit_tdp" id="" value="{{ old('penerbit_tdp') }}"
              placeholder="Di Keluarkan Oleh" >
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Tanggal Di Keluarkan</label>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_tdp" id="" value="{{ old('tgl_keluar_tdp') }}"
              placeholder="Masa Berlaku">
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Masa Berlaku</label>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="masa_berlaku_tdp" id="" value="{{ old('masa_berlaku_tdp') }}"
              placeholder="Masa Berlaku">
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="no_nib" id="" value="{{ old('no_nib') }}"
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-first-name">Tanggal Di Keluarkan </label>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_keluar_nib" id="" value="{{ old('tgl_keluar_nib') }}"
              placeholder="Masa Berlaku">
