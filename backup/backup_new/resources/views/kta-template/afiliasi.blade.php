        ...
        <div class="inner-bg">
            ...
            <div class="content-3">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><small>{!! str_limit(strtoupper($dataKta->nm_bu), 100, ',') !!}</small></td>
            ...
            <div class="content-4">
                ...
                <div class="content-4-bottom">
                    <center><strong><a>AFILIASI</a></strong></center><br>
            ...
            <div class="content-5">
                <table width="100%" height="100" border="0" style="margin-left:20px;">
                    <tr>
                        <td colspan="2">
                            <span style="display:block; text-align:center;font-weight:bold">BKKA Inkindo</span>
                           
                        </td>
                        <td rowspan="2">
                                <center><?php echo '<img src="data:image/png;base64,' . DNS2D::getBarcodePNG($dataKta->npwp_bu, "QRCODE",3,3,array(1,1,1), "green") . '" alt="barcode"   />'; ?></center>
                        </td>
                    ...
                    <tr>
                        <td>
                            <center><img src="{{ public_path('storage/signature/'.$dataKta->ttd_ketua_bkka) }}" style="width:35px"
                                    alt="" srcset=""></center>
                        </td>
                        <td>
                            <center><img src="{{ public_path('storage/signature/'.$dataKta->ttd_sekretaris_bkka) }}" style="width:35px"
                                    alt="" srcset=""></center>
                        </td>
                        <td>
                            <center><img src="{{ public_path('storage/signature/'.$dataKta->ttd_ketum) }}" style="width:35px"
                                    alt="" srcset=""></center>
                        </td>
                        <td>
                            <center><img src="{{ public_path('storage/signature/'.$dataKta->ttd_sekjen) }}" style="width:35px"
                                    alt="" srcset=""></center>
                        </td>
                    ...
                    <tr>
                        <td>
                            <span style="display:block; text-align:center;font-weight:bold">{!! $dataKta->ketua_bkka !!}</span>
                            <span style="display:block; text-align:center;">Ketua BKKA</span>
                        </td>
                        <td>
                            <span style="display:block; text-align:center;font-weight:bold">{!! $dataKta->sekretaris_bkka !!}
                                M.M</span>
                            <span style="display:block; text-align:center">Sekretaris BKKA</span>
                        </td>

                        <td></td>
                        <td>
                            <span style="display:block; text-align:center;font-weight:bold">{!! $dataKta->nm_ketum !!}</span>

                            <span style="display:block; text-align:center">Ketua Umum</span>
                        </td>
                        <td>
                            <span style="display:block; text-align:center;font-weight:bold">{!! $dataKta->nm_sekjen !!}</span>
