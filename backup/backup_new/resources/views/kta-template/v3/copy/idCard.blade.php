...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets-kta/ktaV3/') }}/pengurus.css">
</head>
<body>
                        ...
                        <td width="65%" style="padding:0; vertical-align:top">
                            <table style="width: 100%;" class="table-identity">
                                ...
                                <tr>
                                    ...
                                    <td width="5%">:</td>
                                    <td width="65%">{!! str_limit(ucwords($dataKta->nm_bu), 100, ".") !!}</td>
                                </tr>
                                <tr>
                ...
                <table style="width: 100%;margin-bottom: 0!important;">
                    <tr>
                        ...
                        <td width="25%">
                            ...
                            <center><small>{{ $dataKta->no_kta }}</small></center>
                        </td>
                    </tr>
                </table>
            </div>
