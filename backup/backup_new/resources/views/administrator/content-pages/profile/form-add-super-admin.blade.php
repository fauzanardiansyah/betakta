...
<div class="app-main__inner">
    ...
    <div class="tab-pane tabs-animation fade active show" id="tab-content-1" role="tabpanel">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">Form Tambah Akun Super Admin</h5>
                <form action="{{ route('administrator.profile.add-superadmin-process') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="position-relative row form-group"><label for="exampleEmail"
                        ...
                        <div class="col-sm-10"><input name="nama_admin" id="exampleEmail" placeholder="Nama Admin"
                                type="text" class="form-control" value="{{ old('nama_admin') }}" required>
                    ...
                    <div class="position-relative row form-group"><label for="examplePassword"
                        ...
                        <div class="col-sm-10"><input name="email" id="examplePassword" value="{{ old('email') }}"
                    ...
                    <div class="position-relative row form-group"><label for="examplePassword"
                        ...
                        <div class="col-sm-10"><input name="foto_profile" id="examplePassword"
                                 type="file" class="form-control"
                                placeholder="Email Pengurus"required>
                    ...
                    <div class="position-relative row form-group"><label for="exampleEmail"
                        ...
                        <div class="col-sm-10"><input name="jabatan" id="exampleEmail" placeholder="Jabatan"
                                type="text" class="form-control" value="{{ old('jabatan') }}" required>
