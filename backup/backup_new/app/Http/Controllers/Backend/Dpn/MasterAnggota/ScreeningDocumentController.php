...
class ScreeningDocumentController extends Controller
{
    ...
    public function showDocumenPemberhentiantAnggota($id_detail_kta)
    {
        ...
        return view('backend/dpn/content-pages/master-anggota.screening-pemberhentian', compact('dataAdministrasiBu', 'dataPjbu', 'dataLegalitasBu', 'dataDokumen', 'dataPemberhentian'));
    }
