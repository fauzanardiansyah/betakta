...
class InvoiceAnggotaController extends Controller
{
    ...
    public function getInvoiceAnggota()
    {
        ...
        ->addColumn('action', function ($kta) {
            ...
            elseif ($kta->status_pengajuan == 0 || $kta->status_pengajuan == 3) :
        ...
        if(empty($get_invoice_kta))
        {
          ...
          $publishInvoiceAgt = InvoicePengajuanKta::create([
            ...
            if ($publishInvoiceAgt) {
                ...
                $detail_kta = DetailKta::findOrFail($idDetailKta);

                $update_kta = \App\Kta::where('id', $detail_kta->id_kta)->update([
                ...
                if ($updateKeternagan and $updataNotification and $update_kta) {
                    $dataInvoiceAnggota = [
