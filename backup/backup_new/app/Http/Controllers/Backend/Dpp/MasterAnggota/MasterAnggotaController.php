...
class MasterAnggotaController extends Controller
{
    ...
    public function getDataAnggotaBerhenti()
    {
        ...
        ->addColumn('action', function ($kta) {
            ...
            <a href="'.route('dpp.pemberhentian.approve', ['id_detail_kta' => $kta->id_detail_kta]).'" id="approve-dokumen-anggota" class="btn btn-xs btn-success"  title="Approve Document" ><i class="glyphicon glyphicon glyphicon-saved"></i></a>
