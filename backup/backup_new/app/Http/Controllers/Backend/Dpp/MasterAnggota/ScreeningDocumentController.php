...
class ScreeningDocumentController extends Controller
{
    public function showDocumentAnggotaBaru($id_detail_kta)
    {
        ...
        return view('backend/dpp/content-pages/master-anggota.screening', compact('dataAdministrasiBu', 'dataPjbu', 'legalitasBu', 'dataLegalitasBu', 'dataDokumen', 'dataPemberhentian', 'id_detail_kta'));
    }
    ...
    public function showDocumenPemberhentiantAnggota($id_detail_kta)
    {
        ...
        return view('backend/dpp/content-pages/master-anggota.screening-pemberhentian', compact('dataAdministrasiBu', 'dataPjbu', 'dataLegalitasBu', 'dataDokumen', 'dataPemberhentian'));
    }
