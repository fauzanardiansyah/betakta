...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form action="{{ route('anggota.update.administrasiBadanUsaha') }}" method="POST"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" name="kecamatan" class="form-control" id="" value="{{ $dataAdministrasiBu->kecamatan }}" placeholder="Kecamatan" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" name="kota" class="form-control" id="" value="{{ $dataAdministrasiBu->kota }}" placeholder="Kota" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="number"  name="kd_pos" class="form-control" id="" value="{{ $dataAdministrasiBu->kd_pos }}" placeholder="Kode Pos" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="number" name="no_telp" class="form-control" id="" value="{{ $dataAdministrasiBu->no_telp }}" placeholder="No Telp" required>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="number"   name="no_fax" class="form-control" id="" value="{{ $dataAdministrasiBu->no_fax }}" placeholder="No Fax">
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" name="website" class="form-control" id="" value="{{ $dataAdministrasiBu->website }}" placeholder="Website">
            {!! $errors->first('website', '<p class="" style="padding:5px;background:#CE5454; color:cornsilk">:message</p>') !!}
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-6 col-md-offset-3">
            <input type="hidden" name="id_form_administrasi_bu" value="{{ $dataAdministrasiBu->id }}">
            <input type="hidden" name="id_kta" value="{{ Request::segment(6) }}">
            <button id="send" type="submit" class="btn btn-success">Simpan Perubahan Data Badan Usaha</button>
          </div>
        </div>
