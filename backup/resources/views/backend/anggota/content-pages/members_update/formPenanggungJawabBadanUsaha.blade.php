...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <form action="{{ route('anggota.update.penanggungJawabBadanUsaha') }}" method="POST"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="nm_pjbu" id="w4-username" value="{{ $dataPJBU->nm_pjbu }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <select name="kewarganegaraan" id="kewarganegaraan" class="form-control" required>
              ...
              <option value="wni" <?php echo $result = ($dataPJBU->kewarganegaraan === 'wni') ? "selected" : ""  ?> >WNI</option>
              <option value="wna" <?php echo $result = ($dataPJBU->kewarganegaraan === 'wna') ? "selected" : ""  ?>>WNA</option>
            </select>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input name="nik" id="nik" class="form-control" placeholder="NIK"
              ...
              type="number" maxlength="17" value="{{ $dataPJBU->nik }}" <?php  echo $result = (empty($dataPJBU->nik)) ? "disabled" : "" ?> required />
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" name="passport" id="passport" class="form-control" value="{{ $dataPJBU->no_passport }}" <?php  echo $result = (empty($dataPJBU->no_passport)) ? "disabled" : "" ?>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <select name="jabatan_pjbu" class="form-control" required>
              <option value="">-- Pilih --</option>
              <option value="1" <?php echo $result = ($dataPJBU->jabatan === '1') ? "selected" : ""  ?>>Direktur</option>
              <option value="2" <?php echo $result = ($dataPJBU->jabatan === '2') ? "selected" : ""  ?>>Direktur Utama</option>
              <option value="3" <?php echo $result = ($dataPJBU->jabatan === '3') ? "selected" : ""  ?>>Presiden Direktur</option>
            </select>
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <select name="pendidikan_formal_pjbu" class="form-control" required>
              <option value="">-- Pilih --</option>
              <option value="0" <?php echo $result = ($dataPJBU->pendidikan === '0') ? "selected" : ""  ?>>S1</option>
              <option value="1" <?php echo $result = ($dataPJBU->pendidikan === '1') ? "selected" : ""  ?>>S2</option>
              <option value="2" <?php echo $result = ($dataPJBU->pendidikan === '2') ? "selected" : ""  ?>>S3</option>
              <option value="3" <?php echo $result = ($dataPJBU->pendidikan === '3') ? "selected" : ""  ?>>> S3</option>
            </select>
        ...
        <div class="item form-group">
          <label class="col-sm-3 control-label" for="w4-username">Tempat, Tanggal Lahir<span
              class="required">*</span></label>
          <div class="col-sm-3">
            <input type="text" class="form-control" name="tempat" value="{{ $dataPJBU->tempat }}" placeholder="Tempat"
              required>
            {!! $errors->first('tempat', '<p class=""
              style="margin-top:3px;padding:5px;background:#CE5454; color:cornsilk">:message</p>') !!}
          </div>
          <div class="col-sm-3">
            <input type="date" class="form-control" name="tgl_lahir" value="{{ $dataPJBU->tgl_lahir }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="email" class="form-control" name="email_pjbu" value="{{ $dataPJBU->email_pjbu }}"
        ...
        <div class="item form-group">
          ...
          <div class="col-sm-9">
            <input type="text" data-mask="00.000.000.0-000.000" max="16" class="form-control npwp" name="no_npwp_pjbu"
              value="{{ $dataPJBU->npwp_pjbu }}" placeholder="NPWP PJBU" required>
    ...
    <div class="form-group">
      <div class="col-md-6 col-md-offset-3">
        ...
        <button id="send" type="submit" class="btn btn-success">Simpan Perubahan Data PJBU</button>
      </div>
    </div>
    </form>
  </div>
