                                        ...
                                        <tbody>
                                            ...
                                            <tr id="r2">
                                                ...
                                                <td>
                                                    ...
                                                    IDR. {!!
                                                    number_format($dataInvoiceAnggota['pengurus']->iuran_1_thn_kecil)
                                                    !!}
                                                    @elseif($dataInvoiceAnggota['kta']->kualifikasi == 'menengah')
                                                    IDR. {!!
                                                    number_format($dataInvoiceAnggota['pengurus']->iuran_1_thn_menengah)
                                                    !!}
                                                    @elseif($dataInvoiceAnggota['kta']->kualifikasi == 'besar')
                                                    IDR. {!!
                                                    number_format($dataInvoiceAnggota['pengurus']->iuran_1_thn_besar)
                                                    !!}
                                                    @endif
                                                </td>
                                            </tr>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><strong>IDR.{!! number_format($dataInvoiceAnggota['invoice']->jml_tagihan)
                                                            !!}</strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                ...
                <div class="modal-body">
                    <form action="" id="save-payment-confirmation" enctype="multipart/form-data" method="POST">
                        ...
                        <input type="text" id="nominal" class="form-control" placeholder="nominal"
                            value="{!! number_format($dataInvoiceAnggota['invoice']->jml_tagihan) !!}" disabled>
                        <input type="hidden" name="nominal"
                            value="{!! number_format($dataInvoiceAnggota['invoice']->jml_tagihan) !!}">
