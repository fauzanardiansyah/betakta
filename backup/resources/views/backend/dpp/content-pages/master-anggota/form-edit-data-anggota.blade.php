...
@section('title', 'Edit dokumen Anggota')
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            ...
            <div class="alert alert-success">{{ Session::get('successUpdate') }}</div>
            @endif
            @if (Session::has('failedUpdate'))
            <div class="alert alert-danger">{{ Session::get('failedUpdate') }}</div>
            @endif
            @if ($errors->any())
                    ...
                    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('dpp.edit.update-administrasi-bu-lokal') }}"
                                    method="POST" class="">
                                    @csrf @method('POST')
                    ...
                    <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('dpp.edit.update-penanggung-jawab-bu-lokal') }}"
                    ...
                    <div class="tab-pane tabs-animation fade" id="tab-content-2" role="tabpanel">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('dpp.edit.update-legaliats-bu-lokal') }}" method="POST"
                    ...
                    <div class="tab-pane tabs-animation fade" id="tab-content-3" role="tabpanel">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('dpp.edit.update-dokumen-bu-lokal') }}" method="POST"
                    ...
                    <div class="tab-pane tabs-animation fade" id="tab-content-4" role="tabpanel">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <form action="{{ route("dpp.edit.update-akun-bu-lokal") }}" method="POST">
                                    @csrf
                                    <div class="form-group">
