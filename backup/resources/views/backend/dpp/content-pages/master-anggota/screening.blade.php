...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_title">
            ...
            <a href="{{ url('/panel/dpp/master-anggota/anggota-baru') }}" class="btn btn-sm btn-primary pull-right"  title="Approve Documents" >Back</a>
            @else
            <a href=" {{ route('dpp.master-anggota.approve', ['id_detail_kta' => $id_detail_kta]) }}" id="approve-dokumen-anggota" class="btn btn-sm btn-success pull-right"  title="Approve Documents" ><i class="glyphicon glyphicon glyphicon-saved"></i> Approve Dokumen</a>
            @endif
        </div>
    </div>
</div>
