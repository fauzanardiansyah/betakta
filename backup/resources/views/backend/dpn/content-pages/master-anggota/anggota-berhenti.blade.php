...
@section('title','Master Anggota Pemberhentian')
@section('content-pages')
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Master Anggota Pemberhentian</h2>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="{{ route('dpp.pemberhentian.reject') }}" method="POST" id="form-reject-document" class="form-horizontal" role="form">
                  @csrf
...
$(function() {
    $('#agt-baru-datatable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('dpn.mastertables.berhenti') !!}',
