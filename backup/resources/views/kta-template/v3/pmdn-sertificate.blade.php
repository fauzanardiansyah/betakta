...
<title>Sertifikat-{!! str_limit(strtoupper($dataKta->nm_bu), 46, ',') !!}</title>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets-kta/ktaV3/') }}/ikindo.css" media="all">
</head>
<body>
                        ...
                        <td width="75%">
                            <table style="width: 100%;" class="table-identity">
                                ...
                                <tr>
                                    ...
                                    <td width="5%">:</td>
                                    <td width="65%">{!! ucwords($dataKta->alamat) !!} Kecamatan {!! ucwords($dataKta->kecamatan) !!}, {!! ucwords($dataKta->kota) !!}</td>
                                </tr>
                                <tr>
