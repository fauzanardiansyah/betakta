    ...
    <main>
        ...
        <section class="information" id="information">
            <div class="container">
                                ...
                                <div class="content">
                                    ...
                                    <div class="social">
                                        <ul>
                                            ...
                                            <li>
                                                <b>Bentuk Badan Usaha :</b> {{ $anggotaSemuaProvinsiRow->bentuk_bu  }}
                                            </li>
                                            <li>
                                                <b>Penanggung Jawab Badan Usaha :</b> {{ $anggotaSemuaProvinsiRow->nm_pjbu  }}
                                            </li>
                                            <li class="mt-2">
                                                <a href="javascript:void" class="showmore-member font-weight-bold text-primary" data-toggle="collapse" data-target="#showmore-1" aria-expanded="false" aria-controls="showmore-1">
                                                    Lihat Selengkapnya
                                                </a>
                                            </li>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6 col-lg-4">
                        <a href="{{ route('frontend.informasi.detail-member') }}" class="btn btn-block btn-primary" style="width:300px">
                            Lihat Semua Anggota
                        </a>
                    </div>
                </div>
        ...
        <section class="information">
            <div class="container">
                    ...
                    <div class="col-12">
                        <div class="title">
                            <h2 class="wow fadeInUp" data-wow-delay="0.1s">
                                Daftar Pengurus Inkindo
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                   @foreach ($pengurusInkindo as $pengurusInkindo)
                   <div class="col-12 col-md-6 col-lg-4">
                    <div class="card-branch">
                        <div class="content">
                            <h4 class="name">
                                <a href="profile-detail.html">
                                    {{ $pengurusInkindo->nama_provinsi }}
                                </a>
                            </h4>
                            <!-- <p class="position">
                                Inkindo Branch
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span>
                                        {{ $pengurusInkindo->alamat }}
                                    </span>
                                </li>
                                <li>
                                    <i class="fas fa-phone mr-2"></i>
                                    <span>
                                        {{ $pengurusInkindo->no_telp_dewan_pengurus }}
                                    </span>
                                </li>
                                <li>
                                    <i class="fas fa-envelope mr-2"></i>
                                    <span>
                                        {{ $pengurusInkindo->email_dewan_pengurus }}
                                    </span>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6 col-lg-4">
                        <a href="{{ route('frontend.informasi.detail-pengurus') }}" class="btn btn-block btn-primary">
                            Lihat Semua Anggota
                        </a>
                    </div>
                </div>
