                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 p-0">
                        <div class="login-register">
                            ...
                            <small class="text-center">Masukan password baru anda untuk melakukan reset</small>
                            <!-- Form -->
                            <form action="{{ route('auth.user.reset', ['token' => $user->remember_token]) }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <input type="password" name="password" placeholder="Password terbaru"
                                            class="form-control" required>
                                        <span
                                            style="color:brown;font-size:14px">{{ Session::get('faildResetPasswordRegistrationUsers') }}</span>
                                    </div>
            
                                    <p class="text-center">
                                        <button class="btn btn-template-outlined"><i class="fa fa-sign-in"></i>Reset Now</button>
                                    </p>
