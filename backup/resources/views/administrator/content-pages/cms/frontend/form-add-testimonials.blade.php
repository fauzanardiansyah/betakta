    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <h5 class="card-title">Form tambah testimonials</h5>
                    <form action="{{ route('administrator.cms.frontend-add-testimonials-process') }}" method="POST"
                        class="" enctype="multipart/form-data">
                        @csrf @method('post')
                        <div class="position-relative form-group">
                            <label for="exampleEmail" class="">Nama</label>
                            <input name="nama" id="exampleEmail" placeholder="Nama" type="text" class="form-control">
                        ...
                        <div class="position-relative form-group"><label for="examplePassword"
                                class="">Jabatan</label><input name="jabatan" id="examplePassword" placeholder="Jabatan"
