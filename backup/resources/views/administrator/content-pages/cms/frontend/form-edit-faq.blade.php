        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <form action="{{ route('administrator.cms.frontend-update-faq', ['id' => $faq->id]) }}" method="POST"
                        class="">
                        @csrf @method('post')
                        <div class="position-relative form-group">
                            <label for="exampleEmail" class="">Pertanyaan</label>
                            <input name="question" id="exampleEmail" placeholder="Pertanyaan" value="{{ $faq->question }}" type="text" class="form-control">
                        ...
                        <div class="position-relative form-group"><label for="examplePassword"
                                class="">Jawaban</label>
                                <textarea name="answer" class="form-control" id="answer" cols="30" placeholder="Jawaban" rows="10">{!! $faq->answer !!}</textarea>
