...
class ScreeningDocumentController extends Controller
{
    public function showDocumentAnggotaBaru($id_detail_kta)
    {
        ...
        return view('backend/dpp/content-pages/master-anggota.screening', compact('dataAdministrasiBu', 'dataPjbu', 'legalitasBu', 'dataLegalitasBu', 'dataDokumenBu', 'dataDokumen', 'dataPemberhentian', 'id_detail_kta'));
    }
    ...
    public function showDocumenPemberhentiantAnggota($id_detail_kta)
    {
        ...
        return view('backend/dpp/content-pages/master-anggota.screening-pemberhentian', compact('dataAdministrasiBu', 'dataPjbu', 'dataLegalitasBu', 'dataDokumenBu', 'dataDokumen', 'dataPemberhentian'));
    }
