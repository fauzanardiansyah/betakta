...
class DashboardController extends Controller
{
    ...
    GROUP BY provinsi.`name`
        ...
        if($data_report_table) {
            return Excel::download(new DashboardAdministratorExport($data_report_table), "report_anggota_inkindo-".date('Y-m-d').".xlsx");
        }
    ...
    public function exportToPdf()
    {
            ...
            if($data_report_table) {
                return (new DashboardAdministratorExport($data_report_table))->download("report_anggota_inkindo-".date('Y-m-d').".pdf", \Maatwebsite\Excel\Excel::DOMPDF);
            }
